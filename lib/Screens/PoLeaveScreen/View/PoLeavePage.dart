      ...
      child: Scaffold(
                          ...
                          content: Column(
                            ...
                            children: ["Pending","Accept","Reject"]
                                ...
                                onPressed: () async {
                                  ...
                                  await ApiHelper.apiHelper.getAllLeaveData().then((value) {
          ...
          body: Obx(
              ...
              children: [
                ...
                Text(
                  "Sorry... ${poLeaveController.filterName}${poLeaveController.filterName.value.toLowerCase() == "Pending".toLowerCase() ? "" : "ed"} Leave Data Not Available",
                                ...
                                Expanded(
                                  ...
                                  child: FutureBuilder(future: ApiHelper.apiHelper.getStaffData(staff_id: poLeaveController.leaveDataList[index].userId!), builder:  (context, snapshot) {
                                        ...
                                        children: [
                                            ...
                                            if(snapshot.hasData)
                                              {
                                                ...
                                                return Row(children: [
                                                  Text("Name : ",style: TextStyle(color: Color(0xFF5b1aa0)),),
                                          ...
                                          FutureBuilder(
                                            ...
                                            builder: (context, snapshot) {
                                              if(snapshot.hasData)
                                              {
                                                ...
                                                return Text(
                                                  "Site Name : ${schoolData.companyName}",
                                                  style: const TextStyle(
                                                      color: Color(0xFF5b1aa0),
                                                  ),
                                                );
                                              ...
                                              return Text(
                                                "Site Name : ${poLeaveController.leaveDataList[index].days}",
                                                style: const TextStyle(
                                                    color: Color(0xFF5b1aa0),
                                                ),
                                              );
                                          ...
                                          FutureBuilder(future: ApiHelper.apiHelper.getAllSubSiteData(company_id: staffData.companyId!), builder: (context, snapshot) {
                                            if(snapshot.hasData)
                                            {
                                              ...
                                              return Row(
                                                children: [
                                                  Text("Sub Site Name : ",style: TextStyle(color: Color(0xFF5b1aa0))),
                                          ...
                                          Text(
                                            "Apply Date : ${DateFormat('dd-MM-yyyy').format(poLeaveController.leaveDataList[index].insDateTime!)}",
                                            style: const TextStyle(
                                                color: Color(0xFF5b1aa0)
                                            ),
                                          ),
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        Text(
                                            "Name : ${loginController.UserLoginData.value.name}",
                                            style: const TextStyle(
                                                color: Color(0xFF5b1aa0)
                                            )),
                                        FutureBuilder(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return Text(
                                              "School Name : ${poLeaveController.leaveDataList[index].schoolId}",
                                              style: const TextStyle(
                                                  color: Color(0xFF5b1aa0)
                                              ),
                                            );
